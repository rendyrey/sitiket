...
- `backend`: separate Node.js/Express + MySQL API implementing the v1 domain — see `BACKEND.md`. `backend/src/mcp` holds the local MCP server + tools the assistant's LLM (WhatsApp bot and website chat) acts through.
