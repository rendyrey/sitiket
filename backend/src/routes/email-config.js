...
import { connectGoogleEmailSchema, saveEmailConfigSchema } from "../schemas/email-config-schemas.js";
...
emailConfigRouter.post("/google", validate(connectGoogleEmailSchema), emailConfigController.connectGoogle);
