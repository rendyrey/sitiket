  ...
  return (
    <section className="border-b-4 border-ink bg-lime py-16 sm:py-24">
      <div className="site-container">
        <span className="section-index">DISCOVER / BANDUNG</span>
        <h1 className="mt-5 text-5xl font-black uppercase leading-[.86] text-black xs:text-6xl sm:text-8xl lg:text-[128px]">
          FIND YOUR
          <br />
          NEXT THING.
        </h1>
        <p className="mt-7 max-w-xl text-base font-medium leading-7 text-black/60 sm:text-lg">
          Concerts, matches, markets, conferences, and everything in between—one
          ticket away.
        </p>
      </div>
    </section>
