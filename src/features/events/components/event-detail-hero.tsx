  ...
  return (
    <section className="bg-ink text-white">
      <div className="site-container grid gap-12 py-12 lg:grid-cols-[.85fr_1.15fr] lg:items-center lg:py-20">
        <EventPoster
          event={event}
          className="aspect-[4/5] w-[calc(100%-0.5rem)] max-w-[540px] shadow-[8px_8px_0_#b6ff00] sm:w-[calc(100%-1rem)] sm:shadow-[16px_16px_0_#b6ff00]"
        />
        <div className="lg:pl-8">
          ...
          <h1 className="mt-7 break-words text-4xl font-black uppercase leading-[.92] text-white xs:text-5xl sm:text-7xl lg:text-[88px]">
            {event.title}
          </h1>
          ...
          <div className="mt-8 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <strong className="mt-1 block text-2xl text-lime">
